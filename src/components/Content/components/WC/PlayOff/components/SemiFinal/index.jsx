...
export const SemiFinal = ({ shedule }) => {
  ...
  const change = (scoreOne, scoreTwo, game) => {
    ...
    if (scoreOne > scoreTwo) {
      dispatch({ type: "FINAL", payload: game.teamone });
      dispatch({ type: "THIRD", payload: game.teamtwo });
    }
    if (scoreOne < scoreTwo) {
      dispatch({ type: "FINAL", payload: game.teamtwo });
      dispatch({ type: "THIRD", payload: game.teamone });
    }
  };
  return (
    <>
