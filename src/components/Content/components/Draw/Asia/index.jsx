...
export const DrawAsia = () => {
    const cartStack = useSelector((state) => state.draw.asiaStackCart);
    const carts = useSelector((state) => state.draw.asiaCart);
    const asiaTeams = useSelector(state => state.teams.asia)
    const dispatch = useDispatch()
    const [teams, setTeams] = useState(asiaTeams)
    const qualsGroupAsia = useSelector(state => state.quals.asiaGroups)
