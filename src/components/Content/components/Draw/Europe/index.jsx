...
export const DrawEurope = () => {
  const state = useSelector(state => state)
  const carts = useSelector((state) => state.draw.europeCart);
  const qualsGroupEurope = useSelector(state => state.quals.europeGroups)
  const europeTeams = useSelector(state => state.teams.europe)
  const dispatch = useDispatch()
  const [teams, setTeams] = useState(europeTeams)
...
<br />
      ...
      <div className="groups">
        {qualsGroupEurope.map((group,idx) => {
          return (
